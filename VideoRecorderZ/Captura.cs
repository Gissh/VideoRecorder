...
namespace VideoRecorderZ
{
    public class Captura
    {
...

        {
            ...
            public RecorderParams(string filename, int FrameRate, FourCC Encoder, int Quality,int point11,int point12,int point21,int point22)
            {
                ...
                Height = point22-point12;
                Width = point21 - point11;

                MarginPoint1 = point11;
                MarginPoint2 = point12;
            }
            ...
            public int MarginPoint1 { get; private set; }
            public int MarginPoint2 { get; private set; }
        ...
        public class Recorder : IDisposable
        {
            ...
            public void Screenshot(byte[] Buffer)
            {
                using (var BMP = new Bitmap(Params.Width, Params.Height))
                {
                    ...
                    {
                        g.CopyFromScreen(Params.MarginPoint1, Params.MarginPoint2, 0, 0, BMP.Size);
